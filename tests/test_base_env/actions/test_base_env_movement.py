...
def test_move_right_at_border(tetris_env):
    ...
    tetris_env.reset(seed=42)
    tetris_env.unwrapped.x = tetris_env.unwrapped.width + tetris_env.unwrapped.padding - 1
    tetris_env.step(ActionsMapping.move_right)
    assert tetris_env.unwrapped.x == tetris_env.unwrapped.width + tetris_env.unwrapped.padding - 1
...
def test_move_right_blocked_by_tetromino(tetris_env):
    ...
    tetris_env.reset(seed=42)
    tetris_env.unwrapped.x = 5
    tetris_env.unwrapped.board[0:tetris_env.unwrapped.height, tetris_env.unwrapped.x + 1:tetris_env.unwrapped.x + 5] = 2
    tetris_env.step(ActionsMapping.move_right)
...
def test_move_left_blocked_by_tetromino(tetris_env):
    ...
    tetris_env.reset(seed=42)
    tetris_env.unwrapped.x = 5
    tetris_env.unwrapped.board[0:tetris_env.unwrapped.height, tetris_env.unwrapped.x - 4:tetris_env.unwrapped.x] = 2
    tetris_env.step(ActionsMapping.move_left)
    assert tetris_env.unwrapped.x == 5
...
def test_move_down_blocked_by_tetromino(tetris_env):
    ...
    tetris_env.reset(seed=42)
    tetris_env.unwrapped.y = 5
    tetris_env.unwrapped.board[tetris_env.unwrapped.y + 1:tetris_env.unwrapped.y + 5, 0:tetris_env.unwrapped.width] = 2
    tetris_env.step(ActionsMapping.move_down)
